...
report; a row there is that model's as much as the retriever's. Until such
a row is run, the pack does not claim to beat either system at answering,
and neither of them settles a panel.
